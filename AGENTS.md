...
按 `skills/landscape-color-plan/references/rendering-quality.md` 落实冠层塑形、路段节奏、草地与铺装肌理、岸边接触、相邻材质遮挡及最终饱和度。普通示意街树按路段与实际节点组织变化，已确认规则树阵保持设计；相同缺陷仍明显时修正处理方法，不以工序记录替代质感结果。
